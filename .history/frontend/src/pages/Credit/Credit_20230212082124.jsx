    ...
    return (
        <>
            ...
            <Typography variant="h4" noWrap component="div" style={{ textAlign: "center", marginTop: "2rem" }}>
                Your Current Credit Score is: {sc}
            </Typography>
                        ...
                        {proData.map((products) => {
                            return (
                                <>
                                    ...
                                    <Grid_comp title={products.name} desc={products.description} imgurl={products.imgurl} price={products.price} quantity = {products.quantity} />
