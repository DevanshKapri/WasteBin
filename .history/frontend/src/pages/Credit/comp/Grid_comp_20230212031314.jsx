...
const Grid_comp = () => {
    ...
    return (
        <div className="widget" style={{ height: "35rem" }}>
            <div className="left">

                <span className="title" style={{ textAlign: "center", marginLeft: "3rem", fontSize: "1rem" }}>Product Name</span>
                <span className="title" style={{ textAlign: "center", marginLeft: "3rem", fontSize: "0.7rem" }}>lorem ispsum dolor imit lorem ispsum dolor imit lorem ispsum dolor imitlorem ispsum dolor imitlorem ispsum dolor imitlorem ispsum dolor imit</span>


                <div className="image" style={{ width: "250px", marginLeft: "5rem", marginTop: "6rem" }}>
