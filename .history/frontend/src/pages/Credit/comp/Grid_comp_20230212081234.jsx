    ...
    return (
        <div className="widget" style={{ height: "33rem" }}>
            <div className="left">
                ...
                <span className="title" style={{ textAlign: "center", marginLeft: "3rem", fontSize: "0.7rem" , position: "relative",bottom: "4.5rem" }}>{props.desc}</span>



                <div className="image" style={{ width: "250px", marginLeft: "6.3rem", marginTop: "-25rem" , width: "200px" , height: "100px" , alignItems: "center" }}>
