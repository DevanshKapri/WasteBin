    ...
    return (
        <div className="widget" style={{ height: "33rem" }}>
            <div className="left">
                ...
                <div className="image" style={{ width: "250px", marginLeft: "6.7rem", marginTop: "-17rem" , width: "200px" , height: "100px" , alignItems: "center" }}>
                    <img src={props.imgurl} alt="" style={{height: "180px" , width: "220px"}} />
                </div>
