    ...
    return (
        <div className="widget" style={{ height: "33rem" }}>
            <div className="left">
                ...
                <div className="image" style={{ width: "250px", marginLeft: "6.8rem", marginTop: "-17rem", width: "200px", height: "100px", alignItems: "center" }}>
                    <img src={props.imgurl} alt="" style={{ height: "180px", width: "220px", borderRadius: "15px" }} />
                </div>
                ...
                <div className="buttons" style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                    ...
                    <Button loading variant="solid" style={{ backgroundColor: "rgba(173, 166, 19, 0.2)", width: "8rem", marginLeft: "5rem" }}>
