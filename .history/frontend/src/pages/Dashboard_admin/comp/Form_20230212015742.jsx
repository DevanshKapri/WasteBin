                ...
                <div className='form-css'>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input type="text" className="form-control" id="inputEmail4" onChange={(event) => setTitle(event.target.value)} placeholder="Name of organization" />
                        </div>
