...
router.post("/notification", async (req, res) => {
    ...
    try {
        ...
        client.messages
            .create({
                body: `WasteBin is at your service! We have got your food Waste pickup request fullfield. Please receive your delivery from the given pick-up spot:${address} `,
